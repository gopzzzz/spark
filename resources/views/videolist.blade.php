...
<tr>
    ...
    {{-- Thumbnail --}}
    <td>
        <img src="{{ asset('uploads/thumbnails/' . $bk->thumbnail) }}"
             width="100"
             class="rounded">
    </td>
    ...
    <td>
        <button
            ...
            data-id="{{ $bk->id }}"
            data-title="{{ $bk->title }}"
            data-description="{{ $bk->description }}"
            data-status="{{ $bk->status }}"
            data-thumbnail="{{ asset('uploads/thumbnails/' . $bk->thumbnail) }}"
            data-video="{{ asset('uploads/videos/' . $bk->video) }}">
            Edit
        </button>
    </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3 text-center">
                            ...
                            <img id="video_thumbnail_preview"
                                src=""
                                width="200"
