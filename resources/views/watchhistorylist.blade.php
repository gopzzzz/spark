    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <button
                    type="button"
                    class="btn btn-sm btn-primary editwatchhistory"
                    data-id="{{ $bk->id }}"
...
<div class="modal fade" id="addWatchHistoryModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('storewatchhistory') }}" method="POST">
                @csrf
...
<div class="modal fade" id="editwatchhistorymodal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST"
                action="{{ url('watchhistoryedit') }}"
                name="watchhistoryeditform">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.editwatchhistory').forEach(function(button) {
        ...
        button.addEventListener('click', function () {
            ...
            document.getElementById('watchhistoryid').value =
                this.dataset.id;

            document.getElementById('edit_cus_id').value =
                this.dataset.cusId;
            ...
            var modal = new bootstrap.Modal(
                document.getElementById('editwatchhistorymodal')
            );
