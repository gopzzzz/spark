    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <button
                    type="button"
                    class="btn btn-sm btn-primary editrelatednote"
                    data-id="{{ $bk->id }}"
                    data-video-id="{{ $bk->video_id }}"
                    data-related-notes="{{ $bk->related_notes }}">
                    Edit
                </button>
            </td>
        </tr>
...
<div class="modal fade" id="addRelatedNoteModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('storerelatednote') }}" method="POST">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea
                                ...
                                class="form-control"
                                rows="4"
                                placeholder="Enter related notes">{{ old('related_notes') }}</textarea>
                        </div>
...
<div class="modal fade" id="editrelatednotemodal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST"
                action="{{ url('relatednoteedit') }}"
                name="relatednoteeditform">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea
                                class="form-control"
                                id="edit_related_notes"
                                name="related_notes"
                                rows="5"
                                placeholder="Enter related notes"></textarea>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.editrelatednote').forEach(function(button) {
        ...
        button.addEventListener('click', function () {
            ...
            document.getElementById('edit_related_notes').value =
