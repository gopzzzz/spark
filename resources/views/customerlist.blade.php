        ...
        <tr>
            ...
            <td>
                ...
                @if($bk->image)
                    ...
                    <img src="{{ asset('uploads/customers/' . $bk->image) }}"
                        width="100"
                        class="rounded">
            ...
            <td>
                ...
                <button
                    type="button"
                    class="btn btn-sm btn-primary editcustomer"

                    data-id="{{ $bk->id }}"
                    data-phone="{{ $bk->phone_number }}"
                    data-otp="{{ $bk->otp }}"
                    data-image="{{ asset('uploads/customers/' . $bk->image) }}">
...
<div class="modal fade" id="addCustomerModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('storecustomer') }}"
                method="POST"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.editcustomer').forEach(function(button) {
        ...
        button.addEventListener('click', function () {
            ...
            document.getElementById('customer_otp').value =
                this.dataset.otp;

            document.getElementById('customer_preview').src =
                this.dataset.image;
